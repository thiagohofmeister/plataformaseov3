                            ...
                            <div class="panel-body table-responsive">
                                    ...
                                    <div class="tab-wrapper tab-left ">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="novoPost">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" placeholder="Digite um título" name="titulo" type="text" value="{{ old('titulo') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <select id="disabledSelect" name="id_categoria" class="form-control">
                                                            ...
                                                            <option value="{{ $Categoria->id }}" {{ old('id_categoria') == $Categoria->id ? "selected='selected'" : '' }}>{{ $Categoria->nome }}</option>
                                                            @endforeach
                                                        </select>
                                                        @endif
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-10"> 
                                                    <input class="form-control" placeholder="Home > Categoria > Título da Postagem" name="migalha" type="text" value="{{ old('migalha') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label  class="col-sm-2 control-label">Conteúdo:</label>
                                                <div class="col-sm-10 text-editor">
                                                    <textarea name="conteudo" class="form-control" id="ckeditor_pers" rows="3" placeholder="Solte os dedos, vamos lá!">{{ old('conteudo') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="seo">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" maxlength="65" placeholder="Seo Title" name="seo_title" type="text" value="{{ old('seo_title') }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="nameInput" class="col-sm-2 control-label">Meta Description:</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" maxlength="156" placeholder="Seo Meta Description" rows="3" name="seo_description" cols="50">{{ old('seo_description') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="nameInput" class="col-sm-2 control-label">Spam Text:</label>
                                                <div class="col-sm-10">
                                                    <textarea class="form-control" placeholder="Seo Spam Text" rows="3" maxlength="180" name="seo_spam_text" cols="50">{{ old('seo_spam_text') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="imageInput" class="col-sm-2 control-label">Imagem OpenGraph:</label>
                                                <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button class="btn btn-success" name="status" value="1" type="submit" data-loading-text="...">Publicar</button>
